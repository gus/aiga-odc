...
$(document).ready(function() {
  ...
  var squareApp = new Aiga.FunWithShapes(raphael, {
    width: pageWidth, height: pageHeight, depth: 4, density: 0.07,
  ...
  var circleApp = new Aiga.FunWithShapes(raphael, {
    ...
    createShape: function(raphael, grid) {
      ...
      var system = new Aiga.PlanetarySystem(raphael, moonCount, cx, cy, radius);
      system.draw();
      return system;
    },
  ...
  $("a[href=#square]").click(function() { (currentApp = squareApp).draw(); });
  $("a[href=#triangle]").click(function() { (currentApp = triangleApp).draw(); });
  $("a[href=#circle]").click(function() { (currentApp = circleApp).draw(); });
  currentApp.draw();
