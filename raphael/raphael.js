...
Raphael = (function() {
    ...
    R.getRGB = cacher(function(colour) {
        ...
        ! (({
            hs: 1,
            rg: 1
        })[has](colour.substring(0, 2)) || colour.charAt() == "#") && (colour = toHex(colour));
        var res,
        red,
        green,
        blue,
    ...
    if (R.svg) {
        ...
        var addGradientFill = function(o, gradient, SVG) {
            ...
            fy = .5,
            s = o.style;
            gradient = (gradient + E)[rp](radial_gradient,
            ...
            for (var att in params) {
                if (params[has](att)) {
                    ...
                    case "path":
                        if (o.type == "path") {
                            $(node, {
                                d: value ? attrs.path = roundPath(pathToAbsolute(value)) : "M0,0"
                            });
                        }
                        break;
                    case "width":
        ...
        if (!font.svg) {
            ...
            for (var glyph in font.glyphs) if (font.glyphs[has](glyph)) {
                ...
                fontcopy.glyphs[glyph] = {
                    w: path.w,
                    k: {},
                    d: path.d && "M" + path.d[rp](/[mlcxtrv]/g,
                    function(command) {
                        return {
                            l: "L",
                            c: "C",
    ...
    R.format = function(token, array) {
        ...
        token && R.is(token, "string") && args[length] - 1 && (token = token[rp](formatrg,
        function(str, i) {
